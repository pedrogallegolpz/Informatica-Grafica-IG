...
Lata::Lata(int type){
    ...
    agregar(EntradaNGE( new Material(0.3,10,6000,30.0)));
    ...
    if(brand<0){
        agregar(EntradaNGE( new Material(new Textura("../recursos/imgs/window-icon.jpg"),0.3,10,6000,30.0) ));
    }else if(brand == 0){
        agregar(EntradaNGE( new Material(new Textura("../recursos/imgs/lata-pepsi.jpg"),0.3,10,6000,30.0) ));
    }else{
        agregar(EntradaNGE( new Material(new Textura("../recursos/imgs/lata-coke.jpg"),0.3,10,6000,30.0) ));
    }
...
Peones::Peones(){
    ...
    agregar(EntradaNGE( new Material(0.3,0.8,6000,5.0) ));

    MallaRevolPLY *peon_negro = new MallaRevolPLY("../recursos/plys/peon.ply",33);
    peon_negro->ponerColor(Tupla3f(0.1,0.1,0.1));
    ...
    agregar(EntradaNGE( new Material(0.3,0.2,0.0,0.0) ));
    ...
    nodo_peon_madera->agregar(EntradaNGE( new Material(new TexturaXY("../recursos/imgs/text-madera.jpg"),0.3,1,6000,30.0) ));
